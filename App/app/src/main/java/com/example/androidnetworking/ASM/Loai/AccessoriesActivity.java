package com.example.androidnetworking.ASM.Loai;
...
public class AccessoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle
                ( AccessoriesActivity.this,drawer,toolbar,R.string.navigation_drawer_open,R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        IRetrofitService service = new Retrofitbuilder ().createService ( IRetrofitService.class ,BASE_URL);
        ListView = (ListView) findViewById (R.id.listViewProduct);
        service.get4Product ().enqueue (get1Callback);
...
//        } );
                ...
                new AlertDialog.Builder( AccessoriesActivity.this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent ( AccessoriesActivity.this, AccessoriesActivity.class);
                                startActivity ( i );
                                finish ();
                            }
                        })
        ...
        navigationView.setNavigationItemSelectedListener (new NavigationView.OnNavigationItemSelectedListener () {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId ()){
                    case R.id.nav1:
                        Intent w = new Intent ( AccessoriesActivity.this,ProductActivity2.class);
                        startActivity (w);
                        break;
                    case R.id.nav:
                        Intent o = new Intent ( AccessoriesActivity.this,LaptopActivity.class);
                        startActivity (o);
                        break;
                    case R.id.nav_trangchu:
                        Intent z = new Intent ( AccessoriesActivity.this,MobileActivity.class);
                        startActivity (z);
                        break;
                    case R.id.nav_nike:
                        Intent i = new Intent ( AccessoriesActivity.this,DesktopActivity.class);
                        startActivity (i);
                        break;
                    case R.id.nav_converse:
                        Intent a = new Intent ( AccessoriesActivity.this,AccessoriesActivity.class);
                        startActivity (a);
                        break;
                    case R.id.nav_adidas:
                        Intent s = new Intent ( AccessoriesActivity.this,TabletActivity.class);
                        startActivity (s);
                        break;
        ...
        public void onResponse(Call<ResponseModel> call,Response<ResponseModel> response) {
            if(response.isSuccessful ()){
                ...
                if (model.getStatus ()){
                    ...
                    Toast.makeText ( AccessoriesActivity.this, "Insert Failed", Toast.LENGTH_LONG ).show ();
                }
            }else {
    ...
    final Callback<List<Product>> get1Callback = new Callback<List<Product>> () {
        @Override
        public void onResponse(Call<List<Product>> call,Response<List<Product>> response) {
            if (response.isSuccessful ()) {
                if (data.size ()==0){
                    data = response.body ();
                    apdapter = new ProductApdapter (data,AccessoriesActivity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case  R.id.otp_2:
                Intent a = new Intent (AccessoriesActivity.this,InsertProductActivity.class);
                startActivity (a);
                break;
            case  R.id.otp_3:
                Intent m = new Intent (AccessoriesActivity.this,CartActivity2.class);
                startActivity (m);
                break;
        }
