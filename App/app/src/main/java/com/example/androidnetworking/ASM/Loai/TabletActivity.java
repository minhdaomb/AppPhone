...
public class TabletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle
                ( TabletActivity.this,drawer,toolbar,R.string.navigation_drawer_open,R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        IRetrofitService service = new Retrofitbuilder ().createService ( IRetrofitService.class ,BASE_URL);
        ListView = (ListView) findViewById (R.id.listViewProduct);
        service.get5Product ().enqueue (get1Callback);
...
//        } );
        ...
        ListView.setOnItemLongClickListener ( new AdapterView.OnItemLongClickListener () {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView,View view,int i,long l) {
                new AlertDialog.Builder( TabletActivity.this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent ( TabletActivity.this, TabletActivity.class);
                                startActivity ( i );
                                finish ();
                            }
                        })
        ...
        navigationView.setNavigationItemSelectedListener (new NavigationView.OnNavigationItemSelectedListener () {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId ()){
                    case R.id.nav1:
                        Intent w = new Intent ( TabletActivity.this,ProductActivity2.class);
                        startActivity (w);
                        break;
                    case R.id.nav:
                        Intent o = new Intent ( TabletActivity.this,LaptopActivity.class);
                        startActivity (o);
                        break;
                    case R.id.nav_trangchu:
                        Intent z = new Intent ( TabletActivity.this,MobileActivity.class);
                        startActivity (z);
                        break;
                    case R.id.nav_nike:
                        Intent i = new Intent ( TabletActivity.this,DesktopActivity.class);
                        startActivity (i);
                        break;
                    case R.id.nav_converse:
                        Intent a = new Intent ( TabletActivity.this,AccessoriesActivity.class);
                        startActivity (a);
                        break;
                    case R.id.nav_adidas:
                        Intent s = new Intent ( TabletActivity.this,TabletActivity.class);
                        startActivity (s);
                        break;
        ...
        public void onResponse(Call<ResponseModel> call,Response<ResponseModel> response) {
            if(response.isSuccessful ()){
                ...
                if (model.getStatus ()){
                    ...
                    Toast.makeText ( TabletActivity.this, "Insert Failed", Toast.LENGTH_LONG ).show ();
                }
            }else {
    ...
    final Callback<List<Product>> get1Callback = new Callback<List<Product>> () {
        ...
        public void onResponse(Call<List<Product>> call,Response<List<Product>> response) {
            if (response.isSuccessful ()) {
                if (data.size ()==0){
                    data = response.body ();
                    apdapter = new ProductApdapter (data,TabletActivity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case  R.id.otp_2:
                Intent a = new Intent (TabletActivity.this,InsertProductActivity.class);
                startActivity (a);
                break;
            case  R.id.otp_3:
                Intent m = new Intent ( TabletActivity.this,CartActivity2.class);
                startActivity (m);
                break;
        }
